...
func Default() KeyMap {
	return KeyMap{
		FocusSidebar: key.NewBinding(key.WithKeys("s"), key.WithHelp("s", "sidebar")),
...
func (k KeyMap) FullHelp() [][]key.Binding {
	return [][]key.Binding{
		{k.FocusSidebar, k.Help, k.Refresh, k.Save, k.Select, k.Back, k.Quit},
		{k.Search, k.Reflect, k.Advanced, k.Copy, k.Export},
		{k.NextPane, k.PrevPane, k.Down, k.Up},
	}
}
